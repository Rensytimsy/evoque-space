...
export default function Footer() {
    ...
    return (
        <footer className="bg-[var(--teal-dark-dark)] pt-20 pb-10 px-6 lg:px-12 z-100">
            <div className="max-w-7xl mx-auto">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 lg:gap-16 pb-16 mb-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div>
                            <h2 className="text-2xl text-white tracking-tight mb-2">Evoque Spaces <span className="text-[var(--teal-light)]">Limited</span></h2>
                    ...
                    {[
                        ...
                        <div key={column.title}>
                            <h3 className="text-[var(--teal-light)] font-semibold text-[11px] tracking-[0.2em] uppercase mb-6 ">
                                {column.title}
                            </h3>
                ...
                <div className="flex flex-col md:flex-row justify-between items-center gap-6">
                    <div className="flex items-center gap-8">
                        ...
                        <div className="flex gap-4  text-sm tracking-widest text-slate-500 uppercase">
                ...
                <br />
                <a href="https://www.linkedin.com/in/timothy-mutwiri-9900a2262/" className="text-white underline text-sm">( Website Developed and Designed by Timothy +254746964592 )</a>
            </div>
        </footer>
    )
}