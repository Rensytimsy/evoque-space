...
export default function UnifiedAdminPage({services, categories}:{services : Service[], categories: Category[]}) {
  ...
  const saveMutation = useMutation({
    mutationFn: (data: Service) => {
      return editingService 
        ? axios.put(`${process.env.NEXT_PUBLIC_BACKEND_URL}update-service/`, data)
  ...
  const deleteMutation = useMutation({
    mutationFn: (id: string) => axios.delete(`${process.env.NEXT_PUBLIC_BACKEND_URL}${id}/`),
